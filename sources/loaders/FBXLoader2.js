...
Object.assign( FBXLoader2, {
    ...
    convertFbxTimeToSeconds: function ( time ) {
        ...
        if ( isNaN( parseFloat( time ) ) ) {
            throw new Error( 'FBXLoader2: Unable to convert FBX time for NaN value !' );
        }
        if ( !isFinite( time ) ) {
            throw new Error( 'FBXLoader2: Unable to convert FBX time with infinit value !' );
        }
    ...
    getFbxPropertyData: function ( propertyName, object ) {
        ...
        if ( !propertyName ) {
            throw new Error( 'FBXLoader2: Unable to get FBX property with null or undefined property name !' );
        }
        if ( typeof propertyName !== 'string' ) {
            throw new Error( 'FBXLoader2: Unable to get FBX property ! The property name must be a string.' );
        }
        if ( !object ) {
            throw new Error( 'FBXLoader2: Unable to get FBX property in null or undefined object !' );
        }
    ...
    getFileName: function ( nodeProperties ) {
        ...
        if ( !nodeProperties ) {
            throw new Error( 'FBXLoader2: Unable to search filename in null or undefined nodeProperties !' );
        }
...
Object.assign( FBXLoader2.prototype, (function privateAssignement () {
        ...
        if ( deformer ) {
            ...
            for ( var key in subDeformers ) {
                ...
                for ( var j = 0 ; j < indices.length ; j++ ) {
                    ...
                    if ( weightTable[ index ] === undefined ) {
                        weightTable[ index ] = [];
                    }
            ...
            if ( !model ) {
                ...
                switch ( node.attrType ) {
                    ...
                    case 'NurbsCurve':
                        ...
                        var nurbsMaterial = new LineBasicMaterial( {
                            color:     0x3300ff,
                            linewidth: 5
                        } );
            ...
            for ( var parentsIndex = 0, parentsLength = parents.length ; parentsIndex < parentsLength ; ++parentsIndex ) {
                ...
                if ( version < 7000 ) {
                    ...
                    for ( var i = 0, numberOfGeometry = geometryParents.length ; i < numberOfGeometry ; ++i ) {
                        ...
                        if ( !modelMap.has( geometryParentId ) ) {
                            continue;
                        }
    ...
    function parseAnimations ( FBXTree, connections, sceneGraph, version ) {
        ...
        for ( nodeID in rawCurves ) {
            ...
            if ( !connections.has( animationCurve.id ) ) {
                continue;
            }
    ...
    function parseAnimationNode ( FBXTree, animationCurveNode, connections, sceneGraph ) {
        ...
        if ( !animationNode.attr.match( /S|R|T/ ) ) {
            return null;
        }
    ...
    return {
        ...
        load: function ( url, onLoad, onProgress, onError ) {
            ...
            if ( url === null || url === undefined ) {
                throw new Error( 'FBXLoader2: url cannot be null, or undefined !' );
            }
            if ( onLoad === null || onLoad === undefined ) {
                throw new Error( 'FBXLoader2: onLoad cannot be null, or undefined !' );
            }
            if ( typeof onLoad !== 'function' ) {
                throw new Error( 'FBXLoader2: onLoad must be a function that take an Object3D as parameter !' );
            }
        ...
        parse: function ( FBXBuffer, resourceDirectory ) {
            ...
            if ( FBXBuffer === null || FBXBuffer === undefined ) {
                throw new Error( 'FBXLoader2: FBXBuffer cannot be null, or undefined' );
            }
            if ( resourceDirectory === null || resourceDirectory === undefined ) {
                throw new Error( 'FBXLoader2: resourceDirectory cannot be null, or undefined' );
            }
            ...
            if ( !FBXTree ) {
                throw new Error( 'FBXLoader2: Unable to parse data tree for null or undefined fbx tree !' );
            }
...
Object.assign( TextParser.prototype, {
    ...
    getFbxVersion: function ( text ) {
        ...
        if ( !match ) {
            throw new Error( 'FBXLoader2: Cannot find the version number for the file given.' );
        }

        var version = parseInt( match[ 1 ] );
        if ( !version || version < 6000 ) {
            throw new Error( 'FBXLoader2: FBX version ' + version + ' not supported.' );
        }
