    ...
    computed: {
        ...
        computeStyle() {
            ...
            switch (this.mainAlign) {
                ...
                case 'spaced': style.justifyContent = 'space-between'; break;
                case 'justified': style.justifyContent = 'space-around'; break;
            ...
            switch (this.crossAlign) {
                ...
                case 'baseline': style.alignItems = 'baseline'; break;
                case 'stretch': style.alignItems = 'stretch'; break;
                default: style.alignItems = 'flex-start'; break;
            }

            switch (this.multiLinesAlign) {
                case 'start': style.alignContent = 'flex-start'; break;
                case 'end': style.alignContent = 'flex-end'; break;
                case 'center': style.alignContent = 'center'; break;
                case 'spaced': style.alignContent = 'space-between'; break;
                case 'justified': style.alignContent = 'space-around'; break;
                case 'stretch': style.alignContent = 'stretch'; break;
                default: style.alignContent = 'flex-start'; break;
            }
