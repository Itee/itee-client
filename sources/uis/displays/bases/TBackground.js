...
(function ( $, window ) {
    ...
    if ( typeof NODIX.ui === 'undefined' && NODIX.debug ) {
        throw new Error( 'NODIX.ui need to be define before NODIX.ui.Background, sorry for the disagreement...' );
    }

    var _ui = NODIX.ui;

    _ui.Background = _ui.Background || function Background ( container, backgroundImage ) {
    ...
    _ui.Background.getTemplate = function ( url ) {
        return '<!-- Start of Background -->' +
            '<img src="' + url + '" class="stretch-background display-none">' +
            '<!-- End of Background -->';
    };

    _ui.Background.prototype.initEvents = function () {
    ...
    _ui.Background.prototype.updateBackground = function () {
