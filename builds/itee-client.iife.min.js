...
/**
	 ...
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 */,e.TDataBaseManager=C,e.TIdFactory=class{constructor(e=D.Number,t=null){this.type=e,this.base=t,this._counter=0}get type(){return this._type}set type(e){if(s.isNull(e))throw new Error(`Type cannot be null ! Expect an value from TIdFactoryType enum: ${D.types()}`);if(s.isUndefined(e))throw new Error(`Type cannot be undefined ! Expect an value from TIdFactoryType enum: ${D.types()}`);if(!D.includes(e))throw new Error(`Invalide type ! Expect an value from TIdFactoryType enum: ${D.types()}`);this._type=e}get base(){return this._base}set base(e){if(s.isUndefined(e))throw new Error("Base cannot be undefined ! Expect an instance of Object3D.");if(this._type===D.Number&&s.isNotNumber(e))throw new Error("Invalide Base ! It does not match the type.");if(this._type===D.String&&s.isNotString(e))throw new Error("Invalide Base ! It does not match the type.");this._base=e}setType(e){return this.type=e,this}setBase(e){return this.base=e,this}createId(){return this._base+this._counter++}},e.TIdFactoryType=D,e.TInstancingFactory=class extends c{constructor(e={}){super({...e})}create(e,...t){return super.create(e,...t),new this.get(e)(...t)}},e.TKeyboardController=f,e.TMouseController=
/**
	 * @class
