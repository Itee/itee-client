...
/**
	 ...
	 */
class f{constructor(e={}){document.addEventListener("keydown",f.onKeyDown,!1),document.addEventListener("keyup",f.onKeyUp,!1)}static keyName(e){return null!==f.k[e]?f.k[e]:String.fromCharCode(e)}static onKeyUp(e){var t=f.keyName(e.keyCode);f.status[t]&&(f.status[t].pressed=!1)}static onKeyDown(e){var t=f.keyName(e.keyCode);f.status[t]||(f.status[t]={down:!1,pressed:!1,up:!1,updatedPreviously:!1})}update(){for(var e in f.status)f.status[e].updatedPreviously?f.status[e].down=!1:(f.status[e].down=!0,f.status[e].pressed=!0,f.status[e].updatedPreviously=!0),f.status[e].up?delete f.status[e]:f.status[e].pressed||(f.status[e].up=!0)}down(e){return f.status[e]&&f.status[e].down}pressed(e){return f.status[e]&&f.status[e].pressed}up(e){return f.status[e]&&f.status[e].up}debug(){var e="Keys active: ";for(var t in f.status)e+=" "+t;r.DefaultLogger.log(e)}}f.k=a,f.status={};class g{constructor(e,t=null){this.targetCtor=e,this.serializer=t}to(e,t,s={}){}from(e,t={}){return new this.targetCtor}}const p=t.toEnum({Little:!0,Big:!1}),_=t.toEnum({One:1,Two:2,Four:4,Eight:8});
/**
	 * @class
