 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */,exports.TDataBaseManager=y,exports.TIdFactory=class{constructor(e=v.Number,t=null){this.type=e,this.base=t,this._counter=0}get type(){return this._type}set type(e){if(t.isNull(e))throw new Error(`Type cannot be null ! Expect an value from TIdFactoryType enum: ${v.types()}`);if(t.isUndefined(e))throw new Error(`Type cannot be undefined ! Expect an value from TIdFactoryType enum: ${v.types()}`);if(!v.includes(e))throw new Error(`Invalide type ! Expect an value from TIdFactoryType enum: ${v.types()}`);this._type=e}get base(){return this._base}set base(e){if(t.isUndefined(e))throw new Error("Base cannot be undefined ! Expect an instance of Object3D.");if(this._type===v.Number&&t.isNotNumber(e))throw new Error("Invalide Base ! It does not match the type.");if(this._type===v.String&&t.isNotString(e))throw new Error("Invalide Base ! It does not match the type.");this._base=e}setType(e){return this.type=e,this}setBase(e){return this.base=e,this}createId(){return this._base+this._counter++}},exports.TIdFactoryType=v,exports.TInstancingFactory=class extends d{constructor(e={}){super({...e})}create(e,...t){return super.create(e,...t),new this.get(e)(...t)}},exports.TKeyboardController=c,exports.TMouseController=
/**
 * @class
 ...
 *  See TKeyboardController.k object data below for names of keys whose state can be polled
 */
class{constructor(){}},exports.TStore=h,exports.WebAPIMessage=R,exports.WebAPIMessageData=M,exports.WebAPIMessageError=S,exports.WebAPIMessageProgress=q,exports.WebAPIMessageReady=C,exports.WebAPIMessageRequest=class extends R{static isWebAPIMessageRequest=!0;constructor(e,t=[]){super("_request"),this.method=e,this.parameters=t}get method(){return this._method}set method(e){t.isNull(e)||t.isUndefined(e)||t.isNotString(e)||(this._method=e)}get parameters(){return this._parameters}set parameters(e){t.isNotArray(e)||(this._parameters=e)}toJSON(){return{...super.toJSON(),method:this.method,parameters:this.parameters}}},exports.WebApiMessageResponse=U,exports.WorkerMessage=P,exports.WorkerMessageData=x,exports.WorkerMessageError=I,exports.WorkerMessageMethodCall=class extends P{static isWorkerMessageMethodCall=!0;constructor(e,t=[]){super("methodCall"),this.method=e,this.parameters=t}get method(){return this._method}set method(e){t.isNull(e)||t.isUndefined(e)||t.isNotString(e)||(this._method=e)}get parameters(){return this._parameters}set parameters(e){t.isNotArray(e)||(this._parameters=e)}toJSON(){return{...super.toJSON(),method:this.method,parameters:this.parameters}}},exports.WorkerProgessMessage=$;
