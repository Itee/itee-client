console.log('Itee.Client v7.2.0 - Standalone')
this.Itee = this.Itee || {};
this.Itee.Client = (function (exports, iteeUtils, iteeValidators) {
	...
	class AbstractWebAPI {
	    ...
	    set targetOrigin ( value ) {
	        ...
	        if ( iteeValidators.isUndefined( value ) ) { throw new ReferenceError( `[${ this._origin }]: Target origin cannot be undefined. ${ expectation }` ) }
	        if ( iteeValidators.isNull( value ) ) { throw new ReferenceError( `[${ this._origin }]: Target origin cannot be null. ${ expectation }` ) }
	        if ( iteeValidators.isNotString( value ) ) { throw new ReferenceError( `[${ this._origin }]: Target origin is invalid. ${ expectation }` ) }
