console.log('Itee.Client v7.4.2 - Standalone')
this.Itee = this.Itee || {};
this.Itee.Client = (function (exports, iteeUtils, iteeValidators, iteeCore, uuidv4) {
	'use strict';
	...
	class WebAPIMessage {
	     ...
	     */
	    constructor ( type ) {
	        this._id  = uuidv4__default['default']();
	        this.type = type;
	    }
...
}({}, Itee.Utils, Itee.Validators, Itee.Core, uuidv4));
